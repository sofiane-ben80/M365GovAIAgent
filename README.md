...
The repository contains a working proof of concept and exported agent assets.
The Power Platform target design is complete; tenant implementation follows the
phased migration in the [roadmap](docs/05-Roadmap.md). Do not treat legacy SQL
or SharePoint-list deployment artifacts as the production target.
